...
_How to use_: [README_modeling](https://github.com/yvonnefroehlich/sws-visualization-and-modeling/blob/main/003_modeling/README_modeling.md); header of function [`SWS_modeling_calc_misfit.m`]()\
