    ...
    if ~isempty(meas_phiSC_null)
        for ii = 1:1:length(meas_phiSC_null(:,2))
            plot(meas_BAZ_floor_null(ii), meas_phiSC_null(ii,2), ...
                'o', 'markerfacecolor',color_face_null, ...
...
if strcmp(staname_split,"TMO44")==1 && ...
   strcmp(data_used,"multiWS")==1
    ...
    x_pol_1 = [0.9, 1.3, 1.7,  1.9,  1.9, 1.5, 0.9];
...
if strcmp(staname_split,"TMO07")==1 && ...
   strcmp(data_used,"multiWS")==1
    ...
    x_pol_1 = [0.7, 1.25, 1.5, 1.75, 1.75, 1.5, 1.25, 0.7];
...
if strcmp(staname_split,"BFO")==1 && ...
   strcmp(data_used,"multiWS")==1
    ...
    x_pol_1 = [0.5  0.5  1.25  1.9  1.9  1.2  1.2  0.7  0.7];
    y_pol_1 = [-90  -65   -45  -45  -55  -55  -60  -75  -90];
    pol_1 =  polyshape(x_pol_1,y_pol_1);
    ...
    %            35   15  -25  -25  -35  -35];
    x_pol_2 = [1.2  0.5  0.5  1.2  1.9  1.9  2.25  2.25  2.9  2.9  1.9  1.9  ...
               1.4  0.75  0.75  0.95  0.95  1.7  1.7  0.9];
    y_pol_2 = [-35  -15   30   45   45   45    45    50   50   40   40   35  ...
                35    15    -5    -5   -25  -25  -35  -35];
    pol_2 = polyshape(x_pol_2,y_pol_2);

    %x_pol_3 = [1.0  0.5  0.5  0.8  1.8  2.5  2.5  2.1  2.1  1.0];
    %y_pol_3 = [ 55   70   90   90   60   60   50   50   55   55];
    x_pol_3 = [1.0  0.5  0.5  0.8   1   1  1.5  1.8  2.5  2.5  2.1  2.1  1.0];
    y_pol_3 = [ 55   70   90   90  80  70   70   60   60   50   50   55   55];
    pol_3 = polyshape(x_pol_3,y_pol_3);
...
if strcmp(staname_split,"STU")==1 && ...
   strcmp(data_used,"multiWS")==1
    ...
    x_pol_1 = [0.1  0.1  0.5  0.9  0.9  0.55  0.25];
    y_pol_1 = [-55  -45  -30  -30  -40   -40   -55];
    pol_1 = polyshape(x_pol_1,y_pol_1);

    %x_pol_2 = [0.4  0.1  0.1  0.5  1.7  1.7  2.1  2.1  1.15  1.15  0.8  0.35 ...
    %	       0.35  0.5  0.5  0.5];
    %y_pol_2 = [-20  -10   25   60   60   65   65   55    55    50   50    30 ...
    %	        -5   -5  -15  -20];
    x_pol_2 = [0.4  0.1  0.1  0.3  0.5  1.7  1.7  2.1  2.1  1.15  1.15  0.75 ...
               0.75  0.5 0.35  0.35  0.5  0.5  0.5];
    y_pol_2 = [-20  -10   30   30   60   60   65   65   55    55    50    50 ...
                 45   45   25    -5   -5  -15  -20];
    pol_2 = polyshape(x_pol_2,y_pol_2);

    x_pol_3 = [0.5  0.3  0.3  0.5  1.0  1.7  1.7  1.0  1.0];
...
if strcmp(staname_split,"ECH")==1 && ...
   strcmp(data_used,"multiWS")==1
    ...
    x_pol_1 = [0.5  0.5  0.3  0.3  0.5  0.5  0.1  0.1  0.7  0.7  0.55  0.55 ...
	       0.55  1.1  1.1  1.55  1.55];
    y_pol_1 = [-90  -75  -75  -55  -55  -30  -30  -10  -10  -20   -20   -55 ...
	        -75  -75  -80   -80   -90];
    pol_1 = polyshape(x_pol_1,y_pol_1);

    % x_pol_2 = [0.1  0.1  0.3  0.3  0.45  1.0  1.1  1.9  1.9  1.1  1.1  0.7  ...
    %	       0.7  0.5  0.5  0.3  0.3];
    %y_pol_2 = [ 10   25   25   80    85   85   90   90   80   80   75   75  ...
    %	        70   70   20   20   10] ;
    x_pol_2 = [0.1  0.1  0.3  0.3  0.35  0.35  0.3  0.3  0.45  1.05  1.05  1.1  1.9  ...
	       1.9  1.1  1.1  0.7   0.7   0.5  0.5  0.4   0.4   0.5   0.5  0.3  0.3];
    y_pol_2 = [ 10   25   25   30    30    55   55   80    85    85    90   90   90  ...
	        80   80   75   75    70    70   55   55    30    30    20   20   10] ;
    pol_2 = polyshape(x_pol_2,y_pol_2);
