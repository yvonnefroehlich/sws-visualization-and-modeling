# 002_visualization
 ...
 _How to use_: Header of scripts [`load_models.py`](https://github.com/yvonnefroehlich/sws-visualization-and-modeling/tree/main/002_visualization//02_explore_syn_split_para/load_models.py), [`explore_syn_split_para.py`](https://github.com/yvonnefroehlich/sws-visualization-and-modeling/tree/main/002_visualization//02_explore_syn_split_para/explore_syn_split_para.py)
...
- **[02_explore_syn_split_para](https://github.com/yvonnefroehlich/sws-visualization-and-modeling/tree/main/002_visualization/02_explore_syn_split_para)**: Scripts to plot the synthetic splitting parameters in Python via PyGMT
